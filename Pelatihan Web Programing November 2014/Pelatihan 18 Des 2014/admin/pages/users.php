...
$sqlTampil = "SELECT * FROM `users` ORDER BY id_user ASC LIMIT $posawal,$batas";
...
<div class="main-content">
	<div class="btn-toolbar list-toolbar">
		<div class="row">
			<div class="col-sm-12">
				<a class="btn btn-default pull-right" >Total User : <?php echo $jmlTampil; ?></a>
		        <form class="form-inline" name="formSearch">
		            ...
		            <input name="kataKunci" class="form-control" placeholder="Search username, fullname,email, atau company" id="appendedInputButton" type="text" required>
...
<!-- paging -->	
<?php
	$page = mysql_query("SELECT * FROM `users`");
