...
<body class=" theme-blue">
    <div class="navbar navbar-default" role="navigation">
      <div class="navbar-header">
          ...
          <a href="sd"><span class="navbar-brand"><span class="fa fa-leaf"></span> Nama Perusahaan</span></span></a></div>
  ...
  <!-- menu -->
    <div class="sidebar-nav">
      <ul>
        ...
        <li><a href="#" data-target=".olahdata" class="nav-header collapsed" data-toggle="collapse">
            <i class="fa fa-fw fa-cogs"></i> Setting<i class="fa fa-collapse"></i></a></li>
        <li><ul class="nav nav-list collapse olahdata">
        ...
        <li><a href="" class="nav-header"><i class="fa fa-fw fa-users"></i> Users</a></li>
