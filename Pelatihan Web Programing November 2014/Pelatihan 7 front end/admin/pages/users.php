	...
	<div class="btn-toolbar list-toolbar">
	    <div class="search-well">
	        <form class="form-inline" name="formSearch">
	            ...
	            <input name="kataKunci" class="input-xlarge form-control" placeholder="Search..." id="appendedInputButton" type="text" required>
	            <input class="btn btn-warning btn-search" type="submit" value="Go" />
	        </form>
	    </div>
	</div>
